...
const FlightsHotels = ({showLoader,setCurrentHotelOffers,flightsHotels, inputs }) => {
    ...
    const getDetails = async (id) => {
        try {
            ...
            const response = await axios.get('https://niklas1531-check24.herokuapp.com/offersForFlightHotel', { params: { id, outboundarrivalairport,outbounddepartureairport, departuredate, returndate, countadults, countchildren } })
