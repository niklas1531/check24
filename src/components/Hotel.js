...
const Hotel = ({ showLoader, inputs, setInputs, setHotels }) => {
    ...
    const startSearch = async (e) => {
        ...
        try {
            ...
            const response = await axios.get('https://niklas1531-check24.herokuapp.com/findhotels', { params: { outboundarrivalairport, departuredate, returndate, countadults, countchildren } })
