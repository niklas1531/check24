...
const Hotels = ({showLoader,currentHotelOffers, setCurrentHotelOffers,hotels, inputs }) => {
    ...
    const getDetails = async (id) => {
        try {
            ...
            const response = await axios.get('https://niklas1531-check24.herokuapp.com/offersForHotel', { params: { id, outboundarrivalairport, departuredate, returndate, countadults, countchildren } })
